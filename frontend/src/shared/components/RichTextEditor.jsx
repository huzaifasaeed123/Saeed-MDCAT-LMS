// File: shared/components/RichTextEditor.jsx
  ...
  return (
    <div className="flex flex-wrap gap-1 border-b border-gray-200 pb-2 p-2 bg-gray-50">
      ...
      <select
        ...
        className="px-2 py-1 rounded border border-gray-200 text-xs bg-white hover:bg-gray-100 focus:outline-none focus:ring-1 focus:ring-primary-400"
        title="Heading Level"
      >

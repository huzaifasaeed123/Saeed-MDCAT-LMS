...
import { FiEdit, FiTrash, FiPlus, FiEye, FiLock, FiUnlock, FiEdit3, FiInfo } from 'react-icons/fi';
...
const TestDetail = () => {
  ...
  const getDifficultyBadge = (difficulty) => {
    switch(difficulty) {
      ...
      default:
        return <span className="px-2 py-1 bg-gray-100 text-gray-800 text-xs rounded-full">Medium</span>;
    }
  };
      ...
      <div className="bg-white shadow-md rounded-lg p-6">
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Total: {mcqs.length} questions</p>
          </div>
          <div className="flex space-x-2">
            {mcqs.length > 0 && (
              <Link
        ...
        {mcqs.length === 0 ? (
          <div className="bg-gray-50 text-center py-12 rounded-lg">
            ...
            <p className="text-gray-400 mt-2">
              You need to add at least one question before you can publish this test.
            </p>
          </div>
        ) : (
            ...
            {mcqs.map((mcq, index) => (
              <div key={mcq._id} className="border rounded-lg p-4 hover:bg-gray-50 transition-colors">
                ...
                <div className="text-xs text-gray-500 flex flex-wrap gap-x-4 gap-y-1">
                  ...
                  {mcq.statistics && mcq.statistics.correctPercentage !== undefined && (
